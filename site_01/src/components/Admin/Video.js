        ...
        const getCommonEditTextFieldProps = useCallback(
          ...
          const columns = useMemo(
            () => [
              ...
              {
                accessorKey: 'LearnCode',
                header: 'Хичээлийн код',
                size: 140,
                muiTableBodyCellEditTextFieldProps: ({ cell }) => ({
                  ...getCommonEditTextFieldProps(cell),
                }),
...
export const CreateNewAccountModal = ({ open, onClose, onSubmit,learns }) => {
    const initialState={VideoCode:"",VideoPath:"",LearnCode:""}
    console.log(learns,"buh")
    ...
    //    const {name,value}=e.target;
     ...
     return (
       <Dialog open={open}>
         <DialogTitle textAlign="center"> Видео нэмэх </DialogTitle>
         <DialogContent>
           <form onSubmit={(e) => e.preventDefault()}>
             ...
             >
               ...
               <TextField label="Видео дугаар" value={values.VideoCode} name="VideoCode" onChange={handleChange}/>
   
           
         
               <span>Видео хуулах</span>
               <FileBase64 type="file" multiple={false} onDone={({ base64 }) => setValues({ ...values, VideoPath: base64 })}/>
               ...
               name="LearnCode"
                value={values.LearnCode}
                label="Хичээлийн нэр"
                onChange={handleChange}
                
              >
              {
              learns &&  learns.map((data)=>(
